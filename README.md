...
This repository contains the OCAML implementation of [1]. 
The work is part of the QCOMICAL secondments of Daniel Davàlos at
* University of Urbino (period ..) under the supervision of Claudio Antares Mezzina;
